...
const faqItems = [
  ["هل يحتاج ReachLink إلى بيانات بطاقتي عند التجربة؟", "لا، يمكنك البدء بالتجربة المجانية والحصول على 3 منشورات دون بطاقة."],
  ["هل أستطيع مراجعة المنشور قبل نشره؟", "نعم، يمكنك مراجعة النص وتعديله قبل النشر، أو اختيار الجدولة وفق إعداداتك."],
  ["هل يدعم ReachLink الكتابة بالعربية؟", "نعم، يمكنك إنشاء محتوى بالعربية والإنجليزية وفق جمهورك."],
  ...
  ["هل ينشر ReachLink تلقائيًا في لينكدإن؟", "يمكنك ربط حساب لينكدإن واختيار الجدولة أو مراجعة المنشورات قبل نشرها حسب إعداداتك."],
...
function Landing() {
  ...
  const features = [
    ...
    [Calendar, "جدولة تلقائية ومرنة", "حدد عدد المنشورات وأوقات النشر، أو دع ReachLink يدير الجدول عنك."],
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-hero">
          <div className="mx-auto max-w-7xl px-4 py-16 md:py-32">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-lg text-muted-foreground">ReachLink يكتب لك منشورات لينكدإن مبنية على تخصصك وأهدافك ونبرة صوتك، ثم يساعدك على جدولتها بمرونة. ركّز على عملك، واترك للذكاء الاصطناعي مهمة الحفاظ على حضورك المهني.</p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-muted-foreground">الاستمرارية في لينكدإن تصنع الفرق، لكن البحث عن فكرة وكتابة منشور ثم نشره في الوقت المناسب قد يتحول إلى مهمة مؤجلة دائمًا. ReachLink يحوّل خبرتك وأهدافك إلى محتوى مهني جاهز للنشر، بأسلوب يشبهك لا بأسلوب آلي مكرر.</p>
          </div>
        </section>
        ...
        <section className="bg-gradient-hero py-20">
          <div className="mx-auto max-w-3xl px-4 text-center"><h2 className="text-3xl font-bold md:text-4xl">حضورك المهني يستحق أن يكون مستمرًا</h2><p className="mt-4 text-lg leading-8 text-muted-foreground">لا تنتظر الفكرة المثالية أو الوقت المناسب. أخبر ReachLink عن تخصصك وهدفك، ودع الذكاء الاصطناعي يساعدك على نشر محتوى مهني يعبّر عنك.</p><Link to="/auth" className="mt-8 inline-block"><Button size="lg" className="min-h-12 bg-gradient-primary px-7 shadow-soft">ابدأ 3 منشورات مجانًا <Arrow className="ms-2 inline h-4 w-4" /></Button></Link></div>
        </section>
      </main>

      <footer className="border-t border-border/60 py-10">
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row"><Link to="/" className="flex items-center gap-2"><div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-primary"><Zap className="h-4 w-4 text-primary-foreground" /></div><span className="font-semibold">ReachLink</span></Link><nav className="flex flex-wrap justify-center gap-x-5 gap-y-2 text-sm text-muted-foreground" aria-label="روابط التذييل"><a href="#pricing">الأسعار</a><a href="#how">كيف يعمل</a><a href="#faq">الأسئلة الشائعة</a><a href="/privacy">سياسة الخصوصية</a><a href="/terms">الشروط</a><a href="/contact">التواصل</a></nav></div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">© {new Date().getFullYear()} ReachLink. جميع الحقوق محفوظة.</p>
        </div>
      </footer>
    </div>
  );
