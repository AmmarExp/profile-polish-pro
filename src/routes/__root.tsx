...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ReachLink — AI-powered LinkedIn posting" },
      { property: "og:description", content: "Daily AI-written LinkedIn posts tailored to your specialty and goals." },
