...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "لينك بوست | اكتب وجدول منشورات لينكدإن بالذكاء الاصطناعي" },
      { name: "description", content: "لينك بوست يساعدك على كتابة وجدولة منشورات لينكدإن بالعربية والإنجليزية، وتحسين ملفك المهني لبناء علامتك الشخصية وجذب وظائف وعملاء وفرص أفضل." },
      { property: "og:title", content: "لينك بوست | اكتب وجدول منشورات لينكدإن بالذكاء الاصطناعي" },
      { property: "og:description", content: "لينك بوست يساعدك على كتابة وجدولة منشورات لينكدإن بالعربية والإنجليزية، وتحسين ملفك المهني لبناء علامتك الشخصية وجذب وظائف وعملاء وفرص أفضل." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "لينك بوست | اكتب وجدول منشورات لينكدإن بالذكاء الاصطناعي" },
      { name: "twitter:description", content: "لينك بوست يساعدك على كتابة وجدولة منشورات لينكدإن بالعربية والإنجليزية، وتحسين ملفك المهني لبناء علامتك الشخصية وجذب وظائف وعملاء وفرص أفضل." },
    ...
    links: [
      ...
      { rel: "icon", href: "https://cdn.builder.io/api/v1/image/assets%2F346e6505607b4f3892f8a2e9c5da6d92%2Fb7cab537912b481c8b9aca0820f138bb?format=webp&width=800&height=1200", type: "image/webp" },
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              url: "https://link-enhancer-ai.lovable.app/",
              inLanguage: "ar",
              publisher: { "@type": "Organization", name: "لينك بوست" },
            },
          ],
        }),
      },
