...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ReachLink — انشر على لينكدإن بالذكاء الاصطناعي" },
      { name: "description", content: "مساعدك الذكي لنشر محتوى يومي على لينكدإن، بناءً على تخصصك وأهدافك — عربي وإنجليزي." },
      { property: "og:title", content: "ReachLink — انشر على لينكدإن بالذكاء الاصطناعي" },
      { property: "og:description", content: "مساعدك الذكي لنشر محتوى يومي على لينكدإن، بناءً على تخصصك وأهدافك — عربي وإنجليزي." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ReachLink — انشر على لينكدإن بالذكاء الاصطناعي" },
      { name: "twitter:description", content: "مساعدك الذكي لنشر محتوى يومي على لينكدإن، بناءً على تخصصك وأهدافك — عربي وإنجليزي." },
